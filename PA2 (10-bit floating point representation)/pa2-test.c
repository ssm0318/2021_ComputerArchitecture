...
/* float -> fp10 */
uint32_t test3[N] =	{0x00000001, 0x3fe00000, 0xe0000000, 0x80b5840c, 0x38788000, 0x83f0ffff, 0x36100000};
uint16_t ans3[N] =	{0x0000, 0x00fc, 0xfff0, 0xfe00, 0x0010, 0xfe00, 0x0001};
